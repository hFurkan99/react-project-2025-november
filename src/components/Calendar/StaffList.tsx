...
import { getStaffColor } from "../../utils/colorUtils";
      ...
      {staffs.map((staff) => {
        ...
        return (
          <div
            ...
            style={{
              backgroundColor:
                staff.id === selectedStaffId ? staffColor : "transparent",
          ...
          >
            <svg
              ...
              width="20px"
              style={{
                fill: staff.id === selectedStaffId ? "#fff" : staffColor,
              }}
            >
            ...
            <span
              style={{
                color: staff.id === selectedStaffId ? "#fff" : staffColor,
              }}
            >
              {staff.name}
            </span>
